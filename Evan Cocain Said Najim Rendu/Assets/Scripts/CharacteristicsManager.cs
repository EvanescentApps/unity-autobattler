...
public class CharacteristicsManager : MonoBehaviour{
    ...
    public void DisplayCharacteristics(float maxHealth, float armor, float cooldown, float range, float damage, float speed, string capacityDescription, string capacityName, int price, string recap){
